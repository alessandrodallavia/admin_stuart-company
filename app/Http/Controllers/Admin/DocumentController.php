...
class DocumentController extends Controller
{
    ...
    private function validatedData(Request $request): array
    {
        $validator = validator($request->all(), [
            ...
            'transport_reason' => ['nullable', 'string', 'max:255'],
            'transport_care' => ['nullable', 'string', 'max:255'],
            'transport_start_date' => ['nullable', 'date'],
            'goods_appearance' => ['nullable', 'string', 'max:255'],
            'parcels_count' => ['nullable', 'integer', 'min:0', 'max:999999'],
            'gross_weight_kg' => ['nullable', 'numeric', 'min:0', 'max:99999.99'],
            'net_weight_kg' => ['nullable', 'numeric', 'min:0', 'max:99999.99'],
            'carrier_name' => ['nullable', 'string', 'max:255'],
            'notes' => ['nullable', 'string', 'max:5000'],
            'rounding_adjustment' => ['nullable', 'numeric', 'between:-99999999.99,99999999.99'],
            ...
            'items.*.unit_price' => ['nullable', 'numeric', 'decimal:0,2', 'min:-99999999.99', 'max:99999999.99'],
