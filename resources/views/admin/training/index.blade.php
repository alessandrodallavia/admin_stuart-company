...
@section('content')
    ...
    @if ($isTrainingActive)
        <div class="mt-20 rounded-10 border border-red-300 border-l-4 border-l-red-600 bg-red-50 px-16 py-14">
            ...
            <p class="mt-5 text-14 font-bold leading-[22px] text-black-nike">Tutti i messaggi WhatsApp in ingresso e in uscita funzionano realmente e vengono salvati esclusivamente nello scenario formativo collegato.</p>
            <p class="mt-5 text-14 font-bold leading-[22px] text-red-700">Le proposte e i link pagamento vengono inviati realmente. I pagamenti usano Stripe sandbox e non effettuano addebiti reali.</p>
        </div>
    @endif
