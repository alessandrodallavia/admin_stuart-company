                ...
                <tbody id="items-rows" class="divide-y divide-gray-mid">
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td class="px-8 py-8 align-top"><input data-line-unit-price name="items[{{ $index }}][unit_price]" value="{{ $item['unit_price'] ?? 0 }}" type="number" step="0.01" class="h-50 w-full rounded-10 border-gray-mid px-8 py-6 text-12 font-semibold focus:border-bullstar focus:ring-bullstar"></td>
    ...
    <script>
        ...
        const templates = {
            items: (index) => `<tr>
                ...
                <td class="px-8 py-8 align-top"><input data-line-unit-price name="items[${index}][unit_price]" value="0" type="number" step="0.01" class="h-50 w-full rounded-10 border-gray-mid px-8 py-6 text-12 font-semibold focus:border-bullstar focus:ring-bullstar"></td>
